...
|----------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Comunica oralmente con efectividad a diferentes rangos de audiencia. |**TB1**<br>**Rivera Ayala, Gabriel Alejandro**<br>A lo largo de estas cuatro semanas pude colaborar en la elaboración del Lean UX Process, el proceso de Needfinding, la realización del Impact Map, y establecí la Architectura de Software utilizando gráficos C4. También participé en la planificación y desarrollo inicial del Sprint 1 para la implementación del Landing Page.<br>**Reyes Menacho, Camila Asunción**<br>La implementación del Lean UX process, Lean UX problem Statement, Diseño de entrevistas, Desarrollo de las historias por roles, Elaboración del Web applications UX/UI design y los user flow diagrams, Planeamiento del Sprint 1.<br>**Cisneros Salas, Luis Ángel**<br>En esta entrega se presentó el perfil del startup y del equipo, se registraron y analizaron entrevistas, se introdujeron las User Stories, se definieron las guías de estilo y la arquitectura de la información, y se inició la implementación con el Sprint 1.<br>**Rodríguez Zulueta, Andrés Fernando**<br>Solution Profile, Antecedentes y Problemática, Competidores, Análisis competitivo, Estrategias y tácticas frente a competidores, To-Be Scenario Mapping, Landing Page UI Design, Landing Page Wireframe, Landing Page Mock-up, Software Configuration Management, Software Development Environment Configuration, Source Code Management, Source Code Style Guide & Conventions, Software Deployment Configuration.<br>**Padilla Advíncula, Paolo Sebastian**<br>Durante el TB1 participé activamente en el diseño y construcción de artefactos clave para el entendimiento del usuario y el desarrollo técnico del producto. Me encargué de la elaboración del Lean UX Canvas, la caracterización de segmentos objetivo, y de mapas como el Empathy Mapping y el User Journey Mapping. Además, redacté el Product Backlog y diseñé tanto los Diagramas de Clases como el Diagrama de Base de Datos.<br>**TP**<br>**Rivera Ayala, Gabriel Alejandro**<br>Durante el TP me encargué del desarrollo de componentes clave del frontend de AhorrArte, incluyendo la implementación de la interfaz de usuario para el registro de transacciones y la visualización del balance mensual. También trabajé en la integración de los servicios API falsos para simular la funcionalidad del backend.<br>**Reyes Menacho, Camila Asunción**<br>En el TP desarrollé la funcionalidad de registro de ingresos y egresos, implementé la visualización de gráficos para el análisis financiero y trabajé en el diseño responsivo de la aplicación para dispositivos móviles.<br>**Cisneros Salas, Luis Ángel**<br>Durante el TP implementé el sistema de autenticación del frontend, desarrollé las pantallas de login y registro, y me encargué de la configuración inicial del routing de la aplicación Angular.<br>**Rodríguez Zulueta, Andrés Fernando**<br>En el TP trabajé en el desarrollo de la landing page definitiva, implementé las alertas de exceso de egresos en el frontend y me encargué de la documentación técnica del Sprint 2.<br>**Padilla Advíncula, Paolo Sebastian**<br>Durante el TP desarrollé los componentes de visualización del balance económico actualizado, implementé la funcionalidad de edición de perfil de usuario y trabajé en la optimización de la experiencia de usuario de la aplicación.<br>**TB2**<br>**Rivera Ayala, Gabriel Alejandro**<br>En TB2 me enfoqué en la integración del frontend con el backend desarrollado, implementé las llamadas a las APIs reales y trabajé en la optimización de la comunicación entre ambos sistemas. También participé en la planificación del Sprint 3.<br>**Reyes Menacho, Camila Asunción**<br>Durante TB2 me encargué del diseño y ejecución de las entrevistas de validación con usuarios reales, analicé el feedback recibido y documenté las mejoras necesarias para la aplicación. También contribuí en las evaluaciones heurísticas del sistema.<br>**Cisneros Salas, Luis Ángel**<br>Desarrollé el backend de AhorrArte implementando los endpoints de gestión de usuarios, sistema de autenticación con JWT y la configuración de la base de datos MySQL. También participé en el despliegue de los Web Services.<br>**Rodríguez Zulueta, Andrés Fernando**<br>Durante TB2 realicé la evaluación heurística completa de la aplicación siguiendo los principios de Nielsen, identifiqué problemas de usabilidad y propuse soluciones para mejorar la experiencia de usuario. También contribuí en el diseño de entrevistas de validación.<br>**Padilla Advíncula, Paolo Sebastian**<br>En TB2 implementé el CRUD completo de transacciones financieras en el backend, desarrollé los endpoints para el análisis de datos financieros y trabajé en la documentación de la API con Swagger.<br>**TF**<br>**Rivera Ayala, Gabriel Alejandro**<br><br>**Reyes Menacho, Camila Asunción**<br><br>**Rodríguez Zulueta, Andrés Fernando**<br>Se avanzo con el sprint 4 aplicando mejoras al proyecto y correciones al reporte | **TB1**<br>**Rivera Ayala, Gabriel Alejandro**<br>Concluyo que hemos realizado un buen análisis de las necesidades de nuestros usuarios y que hemos elaborado adecuadamente y de forma colaborativa un producto estructurado y guiado por enfoques como Domain Driven Design.<br>**Reyes Menacho, Camila Asunción**<br>Concluyo que la aplicación de metodologías de UX como Lean UX nos permitió validar tempranamente nuestras hipótesis y diseñar una solución centrada en las necesidades reales de los usuarios en el ámbito de educación financiera.<br>**Cisneros Salas, Luis Ángel**<br>En esta entrega aprendí a estructurar y comunicar claramente el perfil de un startup, a obtener insights valiosos mediante entrevistas, a traducir necesidades en User Stories, a definir guías de diseño coherentes y a organizar la información para una mejor experiencia de usuario. Además, comprendí la importancia de planificar e iniciar la implementación de forma ordenada desde el primer sprint.<br>**Rodríguez Zulueta, Andrés Fernando**<br>Concluyo que el análisis estratégico del mercado financiero, combinado con un diseño centrado en el usuario y una implementación técnica robusta, permiten desarrollar soluciones digitales efectivas que responden a las necesidades reales de educación financiera.<br>**Padilla Advíncula, Paolo Sebastian**<br>Concluyo que aplicar técnicas de diseño centradas en el usuario, como el Empathy Mapping y el User Journey Mapping, permitió al equipo construir una solución coherente con las necesidades reales de los usuarios. Asimismo, la integración entre el diseño conceptual (backlog y clases) facilitó el desarrollo estructurado del producto.<br>**TP**<br>**Rivera Ayala, Gabriel Alejandro**<br>El desarrollo del frontend me permitió comprender la importancia de una interfaz intuitiva y cómo las decisiones de diseño impactan directamente en la experiencia del usuario. La implementación de servicios falsos fue crucial para mantener el progreso del desarrollo mientras se preparaba el backend.<br>**Reyes Menacho, Camila Asunción**<br>Durante el TP confirmé que el diseño responsivo es fundamental para llegar a nuestro público objetivo, especialmente considerando que muchos usuarios accederán desde dispositivos móviles. La visualización de datos financieros debe ser clara y accesible.<br>**Cisneros Salas, Luis Ángel**<br>La implementación del sistema de autenticación me enseñó la importancia de la seguridad desde las primeras etapas del desarrollo. Además, comprendí cómo una buena arquitectura de routing facilita la navegación y mejora la experiencia del usuario.<br>**Rodríguez Zulueta, Andrés Fernando**<br>El desarrollo de la landing page y las alertas del sistema me mostró cómo la comunicación efectiva del valor del producto y la retroalimentación oportuna al usuario son elementos clave para el éxito de una aplicación financiera.<br>**Padilla Advíncula, Paolo Sebastian**<br>El trabajo en los componentes de visualización me demostró que la presentación clara de información financiera compleja es esencial para empoderar a los usuarios en sus decisiones económicas. La optimización de UX requiere atención constante a los detalles.<br>**TB2**<br>**Rivera Ayala, Gabriel Alejandro**<br>La integración frontend-backend me enseñó la importancia de una comunicación fluida entre sistemas y cómo una API bien diseñada facilita el desarrollo de aplicaciones robustas y escalables.<br>**Reyes Menacho, Camila Asunción**<br>Las entrevistas de validación confirmaron que nuestro enfoque está alineado con las necesidades reales de los usuarios. El feedback recibido nos permitió identificar oportunidades de mejora que harán la aplicación más efectiva para promover la educación financiera.<br>**Cisneros Salas, Luis Ángel**<br>El desarrollo del backend me permitió comprender la arquitectura de sistemas distribuidos y la importancia de implementar medidas de seguridad robustas, especialmente en aplicaciones que manejan información financiera sensible.<br>**Rodríguez Zulueta, Andrés Fernando**<br>La evaluación heurística me demostró cómo los principios de usabilidad pueden identificar problemas que impactan la adopción y efectividad de una aplicación. Es crucial evaluar continuamente la experiencia del usuario desde múltiples perspectivas.<br>**Padilla Advíncula, Paolo Sebastian**<br>La implementación del backend de transacciones me enseñó sobre la importancia de diseñar sistemas que puedan escalar y manejar grandes volúmenes de datos financieros de manera eficiente y segura. La documentación clara de APIs es fundamental para el trabajo colaborativo.<br>**TF**<br>**Rivera Ayala, Gabriel Alejandro**<br><br>**Reyes Menacho, Camila Asunción**<br><br>**Rodríguez Zulueta, Andrés Fernando**<br>En esta entrega pude apreder a mejorar la seguridad de una api mediante autenticacion<br> |
| Comunica por escrito con efectividad a diferentes rangos de audiencia | **TB1**<br>**Rivera Ayala, Gabriel Alejandro**<br>Participé en la redacción de la documentación técnica de la arquitectura de software utilizando el modelo C4, desarrollé secciones del Lean UX Process y contribuí en la elaboración de wireframes y mockups con sus respectivas descripciones técnicas.<br>**Reyes Menacho, Camila Asunción**<br>Redacté las historias de usuario con criterios de aceptación claros, documenté el proceso de diseño UX/UI, elaboré la documentación del Impact Mapping y contribuí en la planificación escrita del Sprint 1.<br>**Cisneros Salas, Luis Ángel**<br>Desarrollé la documentación del análisis de competidores, redacté las conclusiones del análisis de entrevistas, contribuí en la elaboración del Product Backlog con descripiciones detalladas y participé en la documentación de las guías de estilo.<br>**Rodríguez Zulueta, Andrés Fernando**<br>Redacté la sección de Antecedentes y Problemática aplicando la metodología 5W+2H, documenté el análisis competitivo completo, elaboré las estrategias frente a competidores y desarrollé toda la documentación de configuración de software y deployment.<br>**Padilla Advíncula, Paolo Sebastian**<br>Elaboré la documentación del Lean UX Canvas, redacté las caracterizaciones de segmentos objetivo, documenté los mapas de empatía y user journey, y desarrollé la documentación técnica de los diagramas de clases y base de datos.<br>**TP**<br>**Rivera Ayala, Gabriel Alejandro**<br>Documenté la implementación de componentes frontend, redacté guías de usuario para las funcionalidades de registro de transacciones y elaboré documentación técnica para la integración con servicios API.<br>**Reyes Menacho, Camila Asunción**<br>Desarrollé la documentación de diseño responsivo, redacté manuales de usuario para la visualización de gráficos financieros y contribuí en la documentación de testing de la aplicación móvil.<br>**Cisneros Salas, Luis Ángel**<br>Redacté la documentación completa del sistema de autenticación, elaboré guías de instalación y configuración, y documenté los procesos de routing de la aplicación Angular.<br>**Rodríguez Zulueta, Andrés Fernando**<br>Desarrollé la documentación técnica del Sprint 2, redacté los manuales de implementación de alertas y contribuí en la documentación de la landing page y sus funcionalidades.<br>**Padilla Advíncula, Paolo Sebastian**<br>Elaboré documentación de componentes de visualización, redacté guías de optimización UX y desarrollé manuales técnicos para la funcionalidad de edición de perfil de usuario.<br>**TB2**<br>**Rivera Ayala, Gabriel Alejandro**<br>Redacté la documentación de integración frontend-backend, elaboré guías técnicas para las llamadas a APIs y desarrollé manuales de troubleshooting para problemas de comunicación entre sistemas.<br>**Reyes Menacho, Camila Asunción**<br>Documenté el proceso completo de validación con usuarios, redacté reportes de feedback y análisis de usabilidad, y elaboré recomendaciones de mejora basadas en los resultados de las entrevistas.<br>**Cisneros Salas, Luis Ángel**<br>Desarrollé la documentación completa de la API del backend, redacté guías de configuración de base de datos MySQL y elaboré manuales de seguridad para el manejo de información financiera sensible.<br>**Rodríguez Zulueta, Andrés Fernando**<br>Redacté el reporte completo de evaluación heurística siguiendo los principios de Nielsen, documenté problemas de usabilidad identificados y elaboré propuestas detalladas de solución.<br>**Padilla Advíncula, Paolo Sebastian**<br>Desarrollé la documentación de la API con Swagger, redacté guías técnicas para el CRUD de transacciones y elaboré manuales de análisis de datos financieros para desarrolladores.<br>**TF**<br>**Rivera Ayala, Gabriel Alejandro**<br><br>**Reyes Menacho, Camila Asunción**<br><br>**Rodríguez Zulueta, Andrés Fernando**<br>Desarrolle la documentacion del sprint 4 y aplique mejoras al resto del proyecto | **TB1**<br>**Rivera Ayala, Gabriel Alejandro**<br>Aprendí que la documentación técnica debe ser precisa pero accesible, adaptando el nivel de detalle técnico según la audiencia. La claridad en diagramas y descripciones es fundamental para la comprensión del sistema.<br>**Reyes Menacho, Camila Asunción**<br>Confirmé que escribir historias de usuario efectivas requiere un equilibrio entre claridad técnica y comprensión del negocio. La documentación UX debe traducir necesidades del usuario en especificaciones implementables.<br>**Cisneros Salas, Luis Ángel**<br>Comprendí que la documentación de análisis competitivo debe presentar información objetiva y accionable. Es crucial adaptar el estilo de escritura según si la audiencia es técnica, comercial o ejecutiva.<br>**Rodríguez Zulueta, Andrés Fernando**<br>Aprendí que documentar problemáticas complejas requiere estructura metodológica clara (como 5W+2H) para que diferentes audiencias puedan comprender tanto el contexto como las soluciones propuestas.<br>**Padilla Advíncula, Paolo Sebastian**<br>Confirmé que la documentación de diseño debe combinar rigor técnico con narrativa clara que permita a stakeholders no técnicos comprender las decisiones de diseño y su impacto en el usuario final.<br>**TP**<br>**Rivera Ayala, Gabriel Alejandro**<br>La documentación de implementación me enseñó la importancia de incluir ejemplos prácticos y casos de uso que faciliten la comprensión tanto para desarrolladores como para usuarios finales.<br>**Reyes Menacho, Camila Asunción**<br>Comprendí que documentar diseño responsivo requiere explicar no solo el "cómo" técnico sino también el "por qué" desde la perspectiva del usuario, especialmente para audiencias de negocio.<br>**Cisneros Salas, Luis Ángel**<br>La redacción de documentación de sistemas de autenticación me mostró la necesidad de balancear información técnica detallada con explicaciones accesibles sobre implicaciones de seguridad.<br>**Rodríguez Zulueta, Andrés Fernando**<br>Aprendí que la documentación de sprints debe ser suficientemente detallada para desarrolladores pero también comprensible para stakeholders que evalúan el progreso del proyecto.<br>**Padilla Advíncula, Paolo Sebastian**<br>La documentación UX me enseñó que explicar decisiones de diseño requiere combinar datos cuantitativos con insights cualitativos de manera que sea convincente para diferentes tipos de lectores.<br>**TB2**<br>**Rivera Ayala, Gabriel Alejandro**<br>Documentar integraciones complejas me demostró la importancia de incluir diagramas y ejemplos que permitan a diferentes audiencias técnicas comprender la arquitectura del sistema.<br>**Reyes Menacho, Camila Asunción**<br>La redacción de reportes de validación me enseñó a presentar resultados de investigación de manera que sean accionables tanto para equipos de desarrollo como para stakeholders de negocio.<br>**Cisneros Salas, Luis Ángel**<br>Documentar APIs me mostró la necesidad de crear materiales que sirvan tanto como referencia técnica para desarrolladores como documentación comprensible para equipos de producto.<br>**Rodríguez Zulueta, Andrés Fernando**<br>La elaboración de reportes de evaluación heurística me enseñó a estructurar hallazgos técnicos de usabilidad de manera que sean comprensibles y accionables para equipos multidisciplinarios.<br>**Padilla Advíncula, Paolo Sebastian**<br>Desarrollar documentación con Swagger me demostró la importancia de crear documentación que sea tanto técnicamente precisa como accessible para desarrolladores con diferentes niveles de experiencia.<br>**TF**<br>**Rivera Ayala, Gabriel Alejandro**<br><br>**Reyes Menacho, Camila Asunción**<br><br>**Rodríguez Zulueta, Andrés Fernando**<br>la elaboracion de los sprints backlog nos ayudo a tener una mejor organizacion como grupo|
---
...
https://202501-i1asi0729-ahorrarte.github.io/AhorrArte-LandingPage
...
Video entrevista 1: https://shorturl.at/gGwPg
Video entrevista 2: https://shorturl.at/Fcdit
